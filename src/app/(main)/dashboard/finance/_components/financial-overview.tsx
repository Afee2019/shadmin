  ...
  return (
    <Card className="shadow-xs">
      <CardHeader>
        ...
        <CardDescription>一目了然地跟踪您的收入、支出和计划金额。</CardDescription>
        <CardAction>
          <Select defaultValue="last-year">
            ...
            <SelectContent>
              <SelectItem value="last-year">去年</SelectItem>
              <SelectItem value="last-month">上个月</SelectItem>
      ...
      <CardContent>
        ...
        <div className="flex flex-col items-start justify-between gap-2 py-5 md:flex-row md:items-stretch md:gap-0">
          ...
          <div className="flex flex-1 items-center justify-center gap-2">
            ...
            <div>
              <p className="text-muted-foreground text-xs uppercase">计划</p>
